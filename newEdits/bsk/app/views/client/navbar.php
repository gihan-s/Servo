    ...
    <nav class="navbar" role="navigation" aria-label="Main navigation">
        ...
        <div class="nav-primary" id="navPrimary">
            ...
            <div class="nav-links" id="navLinks">
                ...
                ?>
                <a href="<?= hlink('/client/dashboard') ?>"
                    class="<?= active('/client/dashboard', $uriNoBase) ?>">
                    <i class="fas fa-th-large"></i>
                    <span>Dashboard</span>
                </a>
                <a href="<?= hlink('/client/jobs') ?>"
                    class="<?= active('/client/jobs', $uriNoBase) ?>">
                    <i class="fas fa-briefcase"></i>
                    <span>Jobs</span>
                </a>
                <a href="<?= hlink('/client/providers') ?>" class="<?= active('/client/providers', $uriNoBase) ?>">
                    <i class="fa-solid fa-users"></i>
                    <span>Providers</span>
                </a>
                <a href="<?= hlink('/client/posts') ?>"
                    class="<?= active('/client/posts', $uriNoBase) ?>">
                    <i class="fa-solid fa-layer-plus"></i>
                    <span>Posts</span>
                </a>
                <a href="<?= hlink('/client/payments') ?>"
                    class="<?= active('/client/payments', $uriNoBase) ?>">
                    <i class="fa-solid fa-credit-card"></i><span>Payments</span></a>
            </div>
        </div>
        <div class="user-menu" id="userMenu">
            <a href="<?= hlink('/client/messages') ?>"
                class="<?= active('/client/messages', $uriNoBase) ?>"
                aria-label="Messages">
            ...
            <div class="user-profile" onclick="window.location.href='<?= hlink('/client/profile') ?>'" role="button" tabindex="0"
                aria-label="Profile">
