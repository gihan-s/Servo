    ...
    <div class="main-section">
        ...
        <form class="login-form" method="POST" action="<?= BASE_URL ?>/login/authenticate">
            <div class="toggle-section user-change">
                <div class="toggle-button active" data-type="client"><i
                        class="fa-solid fa-user"></i>Client</div>
                <div class="toggle-button" data-type="provider"><i
                        class="fa-solid fa-user-helmet-safety"></i>Provider</div>
            </div>
            <input type="hidden" name="type" id="loginType" value="Client" />
