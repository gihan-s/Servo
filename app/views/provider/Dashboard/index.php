...
<head>
    ...
    <style>
        ...
        .range-btn:hover { border-color:#008500; color:#008500; }
        .range-btn.active { background:#008500; color:#fff; border-color:#008500; }
    .chart-wrap { width:100%; height:300px; }
    .chart-scroll { overflow: hidden; }
    .chart-wrap svg { display:block; }
        .chart-grid line { stroke:#e5e7eb; }
    .chart-axis text { fill:#64748b; font-size:12px; font-weight:600; paint-order: stroke; stroke: #fff; stroke-width: 3px; }
    .chart-line { stroke:#4338ca; stroke-width:2.5; fill:none; stroke-linecap:round; stroke-linejoin:round; }
        .chart-point { fill:#6366f1; stroke:#fff; stroke-width:1.5; }
